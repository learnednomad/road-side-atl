...
import adminMembershipPlansRoutes from "./routes/admin-membership-plans";
import adminPricingRulesRoutes from "./routes/admin-pricing-rules";
import adminPricingZonesRoutes from "./routes/admin-pricing-zones";
...
app.route("/admin/membership-plans", adminMembershipPlansRoutes);
app.route("/admin/pricing-rules", adminPricingRulesRoutes);
app.route("/admin/pricing-zones", adminPricingZonesRoutes);
