 ...
 * This language is derived from the Roadside GA onboarding checklist and
...
export const IC_AGREEMENT_SECTIONS: IcAgreementSection[] = [
  {
    ...
    body:
      "You are engaged as an independent contractor (1099), not as an employee, partner, or agent of Roadside GA. You retain sole control over the means, manner, and methods of performing roadside services, including your schedule, route selection, and choice of tools. Nothing in this agreement creates an employer–employee relationship.",
  },
  {
    id: "dispatch-only",
    heading: "2. Roadside GA Is a Dispatch Platform",
    body:
      "Roadside GA operates a technology platform that connects vehicle owners with independent roadside service providers. Roadside GA does not perform repairs, does not directly supervise work performed, and is not a party to the service relationship between you and the customer. All repairs and services rendered are solely your responsibility.",
  },
  {
  ...
  },
  {
    ...
    body:
      "You must maintain, at your own expense, general liability insurance covering your roadside service activities. You acknowledge that Roadside GA's insurance policies do not extend coverage to you or to losses arising from your services. Upon request, you will provide a current certificate of insurance naming the coverage amounts and policy period.",
  },
  {
    id: "hold-harmless",
    heading: "5. Indemnification & Hold Harmless",
    body:
      "You agree to defend, indemnify, and hold harmless Roadside GA, its officers, employees, and affiliates from and against any and all claims, damages, losses, liabilities, costs, and expenses (including reasonable attorneys' fees) arising out of or related to: (a) services you performed or failed to perform; (b) your negligence, willful misconduct, or violation of law; (c) your breach of this agreement; or (d) any third-party claim brought against Roadside GA as a result of your acts or omissions.",
  },
  {
    id: "tax-classification",
    heading: "6. Tax & Withholding",
    body:
      "As an independent contractor, you are solely responsible for the payment of all federal, state, and local taxes on income earned through the platform, including self-employment tax. Roadside GA will not withhold income tax, Social Security, or Medicare contributions from your earnings and will issue an IRS Form 1099 for amounts paid that meet reporting thresholds.",
  },
  {
